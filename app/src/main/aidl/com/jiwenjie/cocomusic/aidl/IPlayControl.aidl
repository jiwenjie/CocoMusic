...
import com.jiwenjie.cocomusic.aidl.IOnSongChangedListener;
import com.jiwenjie.cocomusic.aidl.IOnPlayStatusChangedListener;
import com.jiwenjie.cocomusic.aidl.IOnPlayListChangedListener;
import com.jiwenjie.cocomusic.aidl.IOnDataIsReadyListener;
...
interface IPlayControl {
    ...
    // 设置播放模式 0 列表播放（默认，播放到列表最后时停止播放）1 单曲循环 2 列表循环 3 随机播放
